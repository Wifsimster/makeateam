...
<div class="pure-u-1" id="list">
  ...
  <div class="list-item pure-g">
    <form class="pure-form pure-form-aligned" id="title">
    ...
    <div class="list-item pure-g">
      ...
      <div class="pure-u-3-4">
        <form class="pure-form">
          ...
          <a class="pure-button delete" v-on:click="remove(player)">
...
<div class="list-item pure-g add">
  <div class="control-buttons">
    <button v-on:click="add()" class="pure-button" style="margin-right: 10px;">New player</button>
    <button v-on:click="reset()" class="pure-button">New list</button>
  </div>
</div>

<form class="pure-form pure-form-aligned" id="control">
  <div class="pure-control-group">
  ...
  <div class="control-buttons">
    <button v-on:click="randomize()" class="pure-button pure-button-primary">Randomize</button>
  </div>

  <!--
<div class="list-item">
<pre>{{ playersList | json }}</pre>
</div>
-->
...
<script>
  ...
  export default {
    ...
    methods: {
      add() {
        this.playersList.list.push({id: this.uuid(), name: ''})
      },
      remove(player) {
      ...
      randomize() {
        ...
        for(var i = 1 ; i <= nbTeams ; i++) {
          teams.push({name:'Team '+i, players: players.slice(this.playersByTeam*(i-1), this.playersByTeam*i)});
        }
